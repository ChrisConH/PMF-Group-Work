...
A first comparison of monthly returns can be drawn from the above presented graphs that show the volatility of the four stocks. In the period 2013 to 2016, Amazon and Google seem volatile and record lows could be observed from the Netflix stock while from 2017 to 2021, the three stocks Amazon, Facebook and Google seem to be very volatile, however, Amazon and Netflix have the highest negatives. The graphs show a first overview of the monthly returns, however, for closer investigation and in order to draw better, more exact conclusions, further steps are necessary. Therefore, cumulative monthly returns will be analized in the next chapter.
...
theme_tq() + scale_fill_tq() + facet_wrap(~ symbol, ncol = 2)
```
Now that we have density comparisons of the returns on the stocks between 2013 to 2016 and 2016 to 2021,let's analyze each plot. We could say that NFLX had more volatility in the first period (2013-2016) than in the second one (2017-2021), while the other stocks had remain with a very similar behavior in both periods, being GOOG the less volatile stock, AMZN and FB with a similar density distribution between them, and NFLX keeping the first place in terms of volatility and return.
